    ...
    dbCon().query(sql, async (err) => {
        if (err) {
            ...
            for (var i in json_data) {
                userControlArr.push([
                    json_data[i]['TaxScheme'],
                    json_data[i]['CategoryType'],
                    json_data[i]['RCMType'],
                    json_data[i]['eCommerceGSTIN'],
                    json_data[i]['IGSTonIntraType'],
                    ...
                    json_data[i]['challanNumber'],
                    json_data[i]['challanDate'],
                    json_data[i]['BillFromName'],
                    json_data[i]['BillFromLegalName'],
                    ...
                    json_data[i]['DespatchFromLegalName'],
                    ...
                    json_data[i]['TotalStateCessAmount'],
                    json_data[i]['TotalDiscountAmount'],
                    json_data[i]['TotalRoundoff'],
                ...
                var sql2 = "INSERT INTO " + tableName + " (TaxScheme,\
                CategoryType,\
                RCMType,\
                eCommerceGSTIN,\
                IGSTonIntraType,\
